...
export default function Header() {
    return (
        <header className=" sticky top-0 z-50 flex items-center justify-between px-10 py-6 bg-pink-700 shadow-md h-15">

            <div className="flex items-center gap-3">
                <HiSparkles className="text-3xl text-amber-300" /> {/*logo*/}
                <h2 className="text-lg font-bold text-white">MiniReactApp</h2>
            </div>

            <nav className="flex gap-8 text-white font-medium text-sm uppercase tracking-wider">
